...
request.onupgradeneeded = function(event) {
  ...
  // create an object store (table) called 'new_pizza', set it to have an automated incrementing primary key of sorts
...
request.onsuccess = function(event) {
  ...
  // (from onupgradeneeded() above) or simply established a connection, 
...
// execute function if no internet connection
function saveRecord(record) {
  // open new transaction with the indexdb database (with RW permissions)
